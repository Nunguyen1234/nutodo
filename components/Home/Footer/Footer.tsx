  ...
  return (
    <div className="pt-16 pb-16 bg-gray-100">
      <div className="w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 grid md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        {/* 2nd port */}
        <div className="space-y-5">
          <h1 className="text-lg font-bold text-black">Support</h1>
          <p className="text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950">
            Contact
          </p>
          <p className="text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950">
        ...
        {/* 3rd port */}
        <div className="space-y-5">
          <h1 className="text-lg font-bold text-black">Other Services</h1>
          <p className="text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950">
            Car hire
          </p>
          <p className="text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950">
      ...
      >
        <p className="text-center md:text-left">
          Copyright 2025 Webdev.All right reserved
        </p>
