  ...
  return (
    <div className="bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col">
      ...
      <div className="w-full">
        <input
          type="text"
          className="px-6 py-3.5 bg-white mt-8 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block 
            mx-auto rounded-lg outline-none"
          placeholder="Email"
        />
        <button className="px-6 py-3.5 bg-white hover:bg-blue-950 transition-all duration-200 mt-8 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block 
            mx-auto rounded-lg outline-none">
                Subscibe
                </button>
      </div>
