...
const Newsletter = () => {
  return (
    <div className="bg-[#528afc] pt-16 pb-16 flex items-center justify-center w-full flex-col">
      ...
      <div className="w-full">
        ...
        />
        <button
          className="px-6 py-3.5 bg-blue-900 text-white hover:bg-blue-950 transition-all duration-200 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block 
            mx-auto rounded-lg outline-none"
        >
          Subscibe
        </button>
