...
const HotelCard = ({ hotel }: Props) => {   
  return (
    <div>
      ...
      {/* Content */}
      <div className="mt-4 text-lg font-semibold text-blue-950 hover:text-black cursor-pointer transition-all duration-200">
        <h1>{hotel.name}</h1>
        ...
        <div className="flex items-center space-x-2">
          ...
          <p className="text-sm text-gray-800">Exceptional</p>x
